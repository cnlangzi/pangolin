...
| `tests/src/sse_e2e.rs` | New `ObservableSseBackend` mock + `real_e2e_tunnel_sse_client_disconnect_propagates_to_backend` test | Verify that the backend TCP closes within 1 s of client disconnect. |
